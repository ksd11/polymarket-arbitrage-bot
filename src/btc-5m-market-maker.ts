...
function loadMarketMakerConfig(): MarketMakerConfig {
    const cfg: MarketMakerConfig = {
        ...
        market: envString("MM_MARKET", envString("BTC5M_MARKET", "btc")).toLowerCase(),
        intervalMinutes: envNumber("MM_INTERVAL_MINUTES", envNumber("BTC5M_INTERVAL_MINUTES", 5)),
        ...
        tickSize: envString("MM_TICK_SIZE", envString("BTC5M_TICK_SIZE", "0.01")) as CreateOrderOptions["tickSize"],
        negRisk: envBool("MM_NEG_RISK", envBool("BTC5M_NEG_RISK", config.copytrade.negRisk)),
        minSecondsLeftToQuote: envNumber("MM_MIN_SECONDS_LEFT_TO_QUOTE", 45),
        cancelSecondsBeforeEnd: envNumber("MM_CANCEL_SECONDS_BEFORE_END", envNumber("BTC5M_CANCEL_SECONDS_BEFORE_END", 8)),
