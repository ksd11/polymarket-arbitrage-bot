...
function loadArbConfig(): ArbConfig {
    const cfg: ArbConfig = {
        ...
        market: envString("RANGE_ARB_MARKET", "btc").toLowerCase(),
        intervalMinutes: envNumber("RANGE_ARB_INTERVAL_MINUTES", 5),
        priceX: envNumber("RANGE_ARB_PRICE_X", 0.4),
        usdcPerLeg: envNumber("RANGE_ARB_USDC_PER_LEG", 5),
        tickSize: envString("RANGE_ARB_TICK_SIZE", "0.01") as CreateOrderOptions["tickSize"],
        negRisk: envBool("RANGE_ARB_NEG_RISK", config.copytrade.negRisk),
        minSecondsLeftToOpen: envNumber("RANGE_ARB_MIN_SECONDS_LEFT_TO_OPEN", 60),
        cancelSecondsBeforeEnd: envNumber("RANGE_ARB_CANCEL_SECONDS_BEFORE_END", 8),
